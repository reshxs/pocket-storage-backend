# Generated by Django 4.1.3 on 2022-12-11 13:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "SKU",
                    models.CharField(max_length=16, unique=True, verbose_name="SKU"),
                ),
                (
                    "barcode",
                    models.IntegerField(
                        blank=True, null=True, unique=True, verbose_name="Штрих-код"
                    ),
                ),
                (
                    "updated_at",
